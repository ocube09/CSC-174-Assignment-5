...
<h1 class="centered" >Yidi Fan </h1>
<h4 class="centered">Computer Science Major - Class of 2018</h4>
<img src="images/yidi.jpg" class="img-responsive img-circle margin centeredd" alt="Yidi">
